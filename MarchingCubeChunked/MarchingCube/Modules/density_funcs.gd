...
const FUNC_TYPE: Array[StringName] = [
	&"sample_flat_density",
	&"sample_3d_density",
	&"sample_3d_inverted_density",
	&"sample_2d_density",
	&"sample_sphere_density",
	&"sample_plaetu_density",
	&"sample_moon_density",
]

static var radius := 0.2

static var _FUNCS: Dictionary[StringName, Callable] = {
	&"sample_flat_density": Callable(DensityFuncs, "sample_flat_density"),
	&"sample_3d_density": Callable(DensityFuncs, "sample_3d_density"),
	&"sample_3d_inverted_density": Callable(DensityFuncs, "sample_3d_inverted_density"),
	&"sample_2d_density": Callable(DensityFuncs, "sample_2d_density"),
	&"sample_sphere_density": Callable(DensityFuncs, "sample_sphere_density"),
	&"sample_plaetu_density": Callable(DensityFuncs, "sample_plaetu_density"),
	&"sample_moon_density": Callable(DensityFuncs, "sample_moon_density"),
}


# --- Methods ---

## Get sample function. Expects ones from FUNC_TYPE.
static func get_sampler_func(method: StringName) -> Callable:
	return _FUNCS[method]
...
static func sample_2d_density(noise: Noise, pos: Vector3) -> float:
	...
	var _density: float = pos.y - offset
	var height_weight: float = (1.0 - abs(_density * 2))
...
## Flat density func
static func sample_flat_density(_noise: Noise, pos: Vector3) -> float:
	return pos.y - 0.5
...
static func sample_density(noise: Noise, pos: Vector3, method: StringName) -> float:
	return _FUNCS[method].call(noise, pos)
